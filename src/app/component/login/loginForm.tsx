  ...
  return (
    <div className="flex justify-between">
      <div className="bg-gradient-to-r from-Gradient1-50 to-Gradient1-100 w-[50%] hidden md:flex md:items-center md:justify-center">
        <img src="/Flirtfever Logo-02 1.png" className="w-[600px]" />
      </div>
      <div className="w-full md:w-[50%]">
        <div className="flex justify-center items-center px-5">
          <div className="flex flex-col justify-between md:justify-around h-screen py-12">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm max-w-sm text-AuroMetalSaurus-500 text-center">
                ...
                <span className="text-AuroMetalSaurus-800">
                  Terms of Service
                </span>{" "}
                and{" "}
                <span className="text-AuroMetalSaurus-800">Privacy Policy</span>
                .
              </p>
            </div>
          </div>
